class Student:
    ...
    def addCourse(self, courseName):
        if courseName in self.courses_in_progress and self.grades[courseName] != []:
            self.finished_courses.append(courseName)
        else:
            self.courses_in_progress.append(courseName)
    ...
    def __dict__(self):
        ...
        attributeDict["finishedCourses"] = self.finished_courses
        attributeDict["coursesInProgress"] = self.courses_in_progress
...
student_1.addCourse('Python')
student_1.finished_courses += ['Введение в программирование']
print(f'Список курсов: {student_1.__len__()}')

student_2 = Student('Олег', 'Олегов', 'Male')
student_2.addCourse('Java')
