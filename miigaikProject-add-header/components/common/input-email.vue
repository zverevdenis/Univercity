            ...
            <div class="grt-text-input__slot">
                <div class="grt-text-input__field">
                    <input
                        ...
                        :class="{'er-form': v.$error || isFieldNoDirty, 'val-form': !v.$invalid && email}"
                        type="email"
                        :disabled="disabled"
                        v-model.lazy="email"
                    ...
                    <label
                        ...
                        >Электронная почта<span v-if="required"></span>
                    </label>
                </div>
            </div>
            <div class="grt-text-input__messages">
                <div class="grt-text-input__message">Введите электронную почту</div>
...
.grt-text-input__label:focus {
    ...
    @media (min-width: 768px) {
        transorm: translateY(-12px) scale(0.85);
    }
}
