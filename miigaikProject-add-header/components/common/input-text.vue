            ...
            <div class="grt-text-input__slot">
                <div class="grt-text-input__field">
                    <input
                        ...
                        type="text"
                        :disabled="disabled"
                        v-model.lazy="fieldNameLazy"
                        :id="uniqueIDPrefixForFieldName"
                        required
                        @blur="v.$touch()"
                    />
                    <label
                        class="grt-text-input__label"
                        :class="{ 'grt-text-input__label--focus': fieldNameLazy }"
                        :for="uniqueIDPrefixForFieldName"
                    >
